...
export const answerAddTriggerProd= functions.firestore
...
export const answerUpdateTriggerProd = functions.firestore
    .document(`IbQuestions${dbSuffix}/{docId}/Answers${dbSuffix}/{uid}`)
...
export const answerDeleteTriggerProd = functions.firestore
    .document(`IbQuestions${dbSuffix}/{docId}/Answers${dbSuffix}/{uid}`)
...
export const questionAddTriggerProd = functions.firestore
...
export const questionUpdateTriggerProd = functions.firestore
    .document(`IbQuestions${dbSuffix}/{docId}`)
    .onUpdate(async (snapshot) => {
...
export const questionDeleteTriggerProd = functions.firestore
    .document(`IbQuestions${dbSuffix}/{docId}`)
    .onDelete(async (snapshot) => {
...
export const commentAddTriggerProd = functions.firestore
...
export const commentDeleteTriggerProd = functions.firestore
    .document(`IbQuestions${dbSuffix}/{docId}/Comments${dbSuffix}/{commentId}`)
    .onDelete(async (snapshot) => {
...
export const likeAddTriggerProd = functions.firestore
...
export const likeDeleteTriggerProd = functions.firestore
    .document(`IbQuestions${dbSuffix}/{docId}/Likes${dbSuffix}/{uid}`)
    .onDelete(async (snapshot) => {
...
export const commentLikeAddTriggerProd = functions.firestore
...
export const commentUpdateTriggerProd = functions.firestore
    .document(`IbQuestions${dbSuffix}/{docId}/Comments${dbSuffix}/{commentId}`)
    .onUpdate(async (snapshot) => {
...
export const commentLikeDeleteTriggerProd = functions.firestore
...
export const notificationAddProd = functions.firestore
...
export const chatMemberAddProd = functions.firestore
...
export const chatMemberDeleteProd = functions.firestore
    .document(`IbChats${dbSuffix}/{chatId}/IbMembers${dbSuffix}/{memberId}`)
...
export const chatMsgAddProd = functions.firestore
...
export const chatMsgDeleteProd = functions.firestore
    .document(`IbChats${dbSuffix}/{chatId}/IbMessages${dbSuffix}/{messageId}`)
    .onDelete(async ( snapshot, context) => {
