...
export const answerUpdateTriggerBeta = functions.firestore
    .document(`IbQuestions${dbSuffix}/{docId}/Answers${dbSuffix}/{uid}`)
...
export const answerDeleteTriggerBeta = functions.firestore
    .document(`IbQuestions${dbSuffix}/{docId}/Answers${dbSuffix}/{uid}`)
...
export const questionAddTriggerBeta = functions.firestore
...
export const questionUpdateTriggerBeta = functions.firestore
    .document(`IbQuestions${dbSuffix}/{docId}`)
    .onUpdate(async (snapshot) => {
...
export const questionDeleteTriggerBeta = functions.firestore
    .document(`IbQuestions${dbSuffix}/{docId}`)
    .onDelete(async (snapshot) => {
...
export const commentAddTriggerBeta = functions.firestore
...
export const commentDeleteTriggerBeta = functions.firestore
    .document(`IbQuestions${dbSuffix}/{docId}/Comments${dbSuffix}/{commentId}`)
    .onDelete(async (snapshot) => {
...
export const likeAddTriggerBeta = functions.firestore
...
export const likeDeleteTriggerBeta = functions.firestore
    .document(`IbQuestions${dbSuffix}/{docId}/Likes${dbSuffix}/{uid}`)
    .onDelete(async (snapshot) => {
...
export const commentLikeAddTriggerBeta = functions.firestore
...
export const commentLikeDeleteTriggerBeta = functions.firestore
...
export const notificationAddBeta = functions.firestore
...
export const chatMemberAddBeta = functions.firestore
...
export const chatMemberDeleteBeta = functions.firestore
    .document(`IbChats${dbSuffix}/{chatId}/IbMembers${dbSuffix}/{memberId}`)
...
export const chatMsgAddBeta = functions.firestore
...
export const chatMsgDeleteBeta = functions.firestore
    .document(`IbChats${dbSuffix}/{chatId}/IbMessages${dbSuffix}/{messageId}`)
    .onDelete(async ( snapshot, context) => {
